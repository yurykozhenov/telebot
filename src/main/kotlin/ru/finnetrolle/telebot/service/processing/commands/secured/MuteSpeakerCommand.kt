...
@Component
class MuteSpeakerCommand : AbstractSecuredCommand() {
    ...
    override fun name() = "/MUTE"

    override fun description() = loc.getMessage("telebot.command.description.mute")

    override fun execute(pilot: Pilot, data: String): String {
        return pilotService.setSpeaker(data, false).decide({
            loc.getMessage("messages.user.muted", it.characterName)
        }, {
